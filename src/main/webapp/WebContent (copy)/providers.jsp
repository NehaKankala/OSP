...
<%
    ...
    try {
        ...
        if (serviceType == null) serviceType = "plumbing"; // Default service type for babysitter
...
<head>
    ...
    <style>
        ...
        body {
            ...
            margin: 0;
            padding: 0;
            background: url('<%= serviceType.equals("plumbing") ? "../images/3.jpg" : "../images/service_background.jpg" %>') no-repeat center center fixed;
