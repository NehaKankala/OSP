...
<%
    ...
    try {
        ...
        if (serviceType == null) serviceType = "driving"; // Default service type for babysitter
...
<head>
    ...
    <style>
        ...
        body {
            ...
            margin: 0;
            padding: 0;
            background: url('<%= serviceType.equals("driving") ? "../images/3.jpg" : "../images/service_background.jpg" %>') no-repeat center center fixed;
